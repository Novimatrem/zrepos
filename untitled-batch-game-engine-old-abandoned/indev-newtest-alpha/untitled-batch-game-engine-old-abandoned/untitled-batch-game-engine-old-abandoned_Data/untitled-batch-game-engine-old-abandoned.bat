...
color 4F
color 01
SET ACTUALGAMENAME=fluffy foxy adventures
...
CALL .\depends\cecho  {black}.......................{white}V Block characters loading: V{default}{\n}
...
if %roomid%==1 set ROOMDES1=Please type intro to begin.

if %roomid%==1 set ROOMDES2=But yes, that is a command you can use whenever you wish to look around the     current area.
...
if "%query%"=="highlighted phrases" goto thatsright



if "%query%"=="intro" goto newintro
...
if %MENUINIT%==1 .\depends\sounder.exe .\sfx\mainmenusfx.wav
if %MENUINIT%==1 echo Welcome to %ACTUALGAMENAME%- happy to see you here~ Type [intro] to begin, please use the highlighted words + standard text adventure game commands.
goto updateroom
