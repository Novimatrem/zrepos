...
color 4F
color 01
SET ACTUALGAMENAME=untitled batch game
...
SET MOJANGNAME="the final update"
...
echo under you, after all.
echo.
echo Pulling yourself to your feet, you get up, your back hurting from being
echo in such an uncomfortable position.
...
if %roomid%==1 set ROOMDES1=You look around. It seems that there's a lot of trees, so that probably means   you're in a forest.

if %roomid%==1 set ROOMDES2=One of them is an [apple] tree. You also see something strange nearby- having   basic knowledge, you know what it is: a [monster], but it hasn't seen you yet.
