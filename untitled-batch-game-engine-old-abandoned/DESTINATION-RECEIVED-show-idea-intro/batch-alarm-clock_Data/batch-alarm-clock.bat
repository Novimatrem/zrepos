...
if %turncounter% EQU 12 goto weightending
...
echo.
echo /Novimatrem/
REM purposefully infinite loop forever
:infloop
goto infloop
...
%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%
CALL .\depends\cecho  {\n}
%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%
CALL .\depends\cecho  {\n}
%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%&%blockred%
...
echo.
echo Ensure box is 
echo fully on-screen, 
echo but NOTHING else.
echo.
echo Resize window
echo until it is only
echo showing the red box.
echo.
pause
cls
color 0f
